...
export default function IntroAnimation() {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 overflow-hidden">
            {/* Container */}
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed">
                        Save, organize, and access your favorite websites instantly. <br className="hidden md:block" />
                        Real-time sync across all your devices with secure Google authentication.
                    </p>
                </motion.div>
